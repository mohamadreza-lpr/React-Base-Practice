    ...
    return (
        <div className="course-item">
            ...
            <div className="course-item__detail">
                <CourseBody title={course.title} description={course.description} rate={course.rate} />
    ...
    return (
        <div className="course-item__footer">
            ...
            <div className="caption">
                ...
                <span
                    className={`badge ${
                        course.status === "Active" ? "badge--primary" : course.status === "Upcoming" ? "badge--danger" : "badge--secondary"
                    }`}
                >
                    {course.status}
                </span>
